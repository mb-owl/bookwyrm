"""
Django settings for backwyrm project.
...
SECRET_KEY = 'django-insecure-#hwc36lsm@2vj#2p)k4pm@-u#3bi#(e_5gal@efxh&p84r%uj2'
...
WSGI_APPLICATION = 'backwyrm.wsgi.application'
